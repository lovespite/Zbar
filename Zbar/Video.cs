...
namespace ZBar
{
    ...
    //    /// <returns>
    //    /// A <see cref="ZbImage"/> representating the next image captured
    //    /// </returns>
    //    public ZbImage NextFrame()
    //    {
    //        IntPtr image = NativeZBar.zbar_video_next_image(this.video);
    //        if (image == IntPtr.Zero)
    //            throw new ZBarException(this.video);
    //        return new ZbImage(image, false); //I don't think we need to increment reference count here..
    //    }
