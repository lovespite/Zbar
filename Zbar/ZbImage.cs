...
namespace ZBar
{
    ...
    /// </summary>
    public class ZbImage : IDisposable
    {
        /// <summary>
        ...
        /// </param>
        internal ZbImage(IntPtr handle, bool incRef)
        {
            this.handle = handle;
        ...
        /// </remarks>
        public ZbImage(System.Drawing.Image image) : this()
        {
        ...
        public System.Drawing.Bitmap ToBitmap()
        {
            ...
            using (ZbImage rgb = Convert(FourCC('R', 'G', 'B', '3')))
            {
                byte[] data = rgb.Data;
        ...
        public byte[] Data
        {
            ...
            set
            {
                ...
                NativeZBar.zbar_image_set_data(this.handle, data, (uint)value.Length, ZbImage.CleanupHandler);
            }
        }
        ...
        /// </param>
        /// <returns>
        /// A new <see cref="ZbImage"/> with the sample data from the original image converted to the requested format.
        /// The original image is unaffected.
        /// </returns>
        public ZbImage Convert(uint format)
        {
            IntPtr img = NativeZBar.zbar_image_convert(this.handle, format);
            if (img == IntPtr.Zero)
                throw new Exception("Conversation failed!");
            return new ZbImage(img, false);
        }
